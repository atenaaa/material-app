...
function Footer({ setValue, setSelectedIndex }) {
    ...
    return (
        <footer className={classes.footer}>
                ...
                <Grid container justifyContent="center" className={classes.mainContainer}>
                    ...
                    <Grid item className={classes.gridItem}>
                        <Grid container direction="column" spacing={2}  >
                            ...
                            <Grid component={Link} onClick={() => { setValue(1); setSelectedIndex(3) }} to="/websites" item className={classes.link}>
                                Website Development
                            </Grid>
                        </Grid>
                    </Grid>
                    ...
                    <Grid item className={classes.gridItem}>
                        <Grid container direction="column" spacing={2}  >
                            <Grid item component={Link} onClick={() => { setValue(1); setSelectedIndex(0) }} to="/revolution" className={classes.link}>
                                The Recolotion
                            </Grid>
                            <Grid item component={Link} onClick={() => { setValue(1); setSelectedIndex(1) }} to="/revolution" className={classes.link}>
                                Vision
                            </Grid>
                            <Grid item component={Link} onClick={() => { setValue(1); setSelectedIndex(2) }} to="/revolution" className={classes.link}>
                                Technology
                            </Grid>
                            <Grid item component={Link} onClick={() => { setValue(1); setSelectedIndex(3) }} to="/revolution" className={classes.link}>
                                Process
                            </Grid>
                        </Grid>
                    </Grid>
            ...
            <img alt="black decorative" src={Footersdornment} className={classes.adorment} />

            <Grid container justifyContent="flex-end" className={classes.socialContainer} spacing={2}>
                <Grid item component={"a"} href="https://www.facebook.com" rel="noopenr noreferrer" target="_blank">
